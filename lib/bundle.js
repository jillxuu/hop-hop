...
class Platform {
  ...
  //     let platformFirst = this.platforms[i];
  //     for (let j = i + 1;j < this.platforms.length; j++){
  //       let platformSecond = this.platforms[j];
  //       if (platformFirst.x - platformSecond.x < this.width){
  //         platformFirst.x -= this.width;
  //       }
  //       if (platformFirst.y - platformSecond.y < this.height) {
  //         platformFirst.y -= this.height;
  //       }
  //     }
  //   }
  // }
