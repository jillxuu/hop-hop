...
class Naruto {
  constructor(){
    ...
    this.image.src = './assets/images/narutoLeft.png';
  }
...
function gameOver(){
  ...
  setTimeout(() => {
    ...
    ctx.fillText("GAME OVER", width/2-60, 150);
    ctx.fillText("Your Score is: " + points, width/2-80, 180);
    ctx.fillText("Press 'ENTER' to Play Again!", width/2-120, 210);
  }, 1000);
  gameover.play();
  setTimeout(()=> {
    gameover.pause();
